...
export declare class PronunciationDictionariesClient {
     ...
     *     })
     */
    createFromFile(request: ElevenLabs.BodyAddAPronunciationDictionaryV1PronunciationDictionariesAddFromFilePost, requestOptions?: PronunciationDictionariesClient.RequestOptions): core.HttpResponsePromise<ElevenLabs.AddPronunciationDictionaryResponseModel>;
     ...
     *     })
     */
    createFromRules(request: ElevenLabs.BodyAddAPronunciationDictionaryV1PronunciationDictionariesAddFromRulesPost, requestOptions?: PronunciationDictionariesClient.RequestOptions): core.HttpResponsePromise<ElevenLabs.AddPronunciationDictionaryResponseModel>;
     ...
     */
    update(pronunciation_dictionary_id: string, request?: ElevenLabs.BodyUpdatePronunciationDictionaryV1PronunciationDictionariesPronunciationDictionaryIdPatch, requestOptions?: PronunciationDictionariesClient.RequestOptions): core.HttpResponsePromise<ElevenLabs.GetPronunciationDictionaryMetadataResponse>;
    private __update;
    /**
     * Get a PLS file with a pronunciation dictionary version rules
     * @throws {@link ElevenLabs.UnprocessableEntityError}
     */
    download(dictionary_id: string, version_id: string, requestOptions?: PronunciationDictionariesClient.RequestOptions): core.HttpResponsePromise<ReadableStream<Uint8Array>>;
    private __download;
    /**
     ...
     *     })
     */
    list(request?: ElevenLabs.PronunciationDictionariesListRequest, requestOptions?: PronunciationDictionariesClient.RequestOptions): core.HttpResponsePromise<ElevenLabs.GetPronunciationDictionariesMetadataResponseModel>;
    private __list;
}
