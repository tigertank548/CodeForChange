...
import { type DataTrackDeserializeErrorAll, DataTrackSerializeError, type DataTrackSerializeErrorAll, DataTrackSerializeErrorReason } from './errors';
...
export declare class DataTrackPacketHeader extends Serializable {
    ...
    static fromBinary<Input extends DataView | ArrayBuffer | Uint8Array>(input: Input): Throws<[header: DataTrackPacketHeader, byteLength: number], DataTrackDeserializeErrorAll>;
    toJSON(): {
        marker: FrameMarker;
        trackHandle: number;
        sequence: number;
...
export declare class DataTrackPacket extends Serializable {
    ...
    static fromBinary<Input extends DataView | ArrayBuffer | Uint8Array>(input: Input): Throws<[packet: DataTrackPacket, byteLength: number], DataTrackDeserializeErrorAll>;
    toJSON(): {
        header: {
            marker: FrameMarker;
            trackHandle: number;
